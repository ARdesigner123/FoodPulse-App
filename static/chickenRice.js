...
const vendorChickenRicePrice = document.getElementById("vendorChickenRicePrice");
...
const vendorExtraRicePrice = document.getElementById("vendorExtraRicePrice");
const vendorExtraRiceQuantity = document.getElementById("vendorExtraRiceQuantity");
const vendorBraisedEggPrice = document.getElementById("vendorBraisedEggPrice");
const vendorBraisedEggQuantity = document.getElementById("vendorBraisedEggQuantity");
const vendorExtraChickenPrice = document.getElementById("vendorExtraChickenPrice");
...
const errorText = document.getElementById("errorText"); // New: For displaying errors
...
if (logLeftoversBtn) {
    logLeftoversBtn.addEventListener("click", () => {
        ...
        // Validation: Check for blanks, non-numeric, or negative values
        const inputs = [
            { value: vendorChickenRicePrice.value, name: "Chicken Rice Price" },
            ...
            { value: vendorExtraRicePrice.value, name: "Extra Rice Price" },
            { value: vendorExtraRiceQuantity.value, name: "Extra Rice Quantity" },
            { value: vendorBraisedEggPrice.value, name: "Braised Egg Price" },
            { value: vendorBraisedEggQuantity.value, name: "Braised Egg Quantity" },
            { value: vendorExtraChickenPrice.value, name: "Extra Chicken Price" },
        ...
        const payload = {
            chickenRicePrice: parseFloat(vendorChickenRicePrice.value),
            ...
            extraRicePrice: parseFloat(vendorExtraRicePrice.value),
            extraRiceQuantity: parseInt(vendorExtraRiceQuantity.value),
            braisedEggPrice: parseFloat(vendorBraisedEggPrice.value),
            braisedEggQuantity: parseInt(vendorBraisedEggQuantity.value),
            extraChickenPrice: parseFloat(vendorExtraChickenPrice.value),
